                                                ...
                                                <tr class="gradeX odd" role="row">
                                                   ...
                                                   <td class="center">
                                                      <form action="{{route('visitors.delete_visit', [$history->id])}}" method="POST">
                                                         @method('DELETE')
                                                         @csrf
    <a href="edit-employee.html" class="btn btn-tbl-edit edit_visit" data-toggle="modal" data-target=".ed-example-modal-lg" data-id="{{ $history->id }}" >
                           ...
                           <form method="POST" action="" id="visitform" enctype="multipart/form-data">
                              ...
                              <div class="row clearfix">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <div class="form-line">
                                          <button  type="button"  Style="width:123px; float:right;margin-right:5% "  class="btn btn-danger waves-effect "  data-dismiss="modal"
                  >Cancel Visit</button>
                                       </div>
                                    </div>
                                 </div>
               ...
               <div class="row clearfix">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="card">
                       <!--  <div class="header">
                           <label>Visitor Name:</label>
                           <h2 style="color:#fff; margin-bottom: 7px" ></h2>
                           <label>Visitor Id:</label>
                           <h2 style="color:#fff" ></h2>
                        </div> -->
                        <div class="body">
                           <form method="POST" action="" id="editvisitform" enctype="multipart/form-data">
                              @csrf
                              ...
                              <div class="row clearfix">
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line"  style="margin-top: 26px;">
                                          <select class="form-control" id="dep_id" name="department_id">
                                            
                                          </select>
                                          <span id="dep_error"></span>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line"  style="margin-top: 26px;">
                                          <select class="form-control" name="user_id" id="u_id">
                                          </select>
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line">
                                          <select class="form-control" name="visitor_type" id="visitor_t_id">
                                            
                                          </select>
                                          <span id="visitor_t_error"></span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row clearfix">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line">
                                          <input type="text" id="datepicker1" name="end_date" class="datepicker2 form-control" placeholder="End Date"
                                              required />                 
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line">
                                          <input type="text" name="visiting_area" class="form-control" placeholder="Visiting Area" id="visiting_area1">
                                          <span id="v_area_error1"> </span>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line">
                                          <h5>Check In Time</h5>
                                          <input type="time" id="check_in_time1" name="check_in_time"  class="form-control " placeholder="Check in Time">
                                          <span id="c_in_error1"></span>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row clearfix">       
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line">
                                          <h5>Check Out Time</h5>
                                          <input type="time" id="check_out_time1" name="check_out_time" class="form-control" placeholder="Check Out Time">
                                          <span id="c_out_error1"></span>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line">
                                          <select class="form-control" id="visit_purpose_id" name="purpose_id">
                                            
                                          </select>
                                          <span id="P_v_error1"></span>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-4">
                              ...
                              <div class="row clearfix">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">
                                       <div class="form-line">
                                          <input type="text" id="vehicle_no" name="vehicle_no" class="form-control" placeholder="Vehicle No">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row clearfix">
                                 <div class="col-md-4">
                                    <div class="capture" id="">
                                       <img src="/admin_assets/images/capture.png" id="image-tag1">
                                       <!-- <input type="text" name="image" id="image-tags"> -->
                                    </div>
                                    <div class="col-md-6">
                                       <div id="my_camera1"></div>
                                       <br/>
                                       <input type="button" value="Access Camera" onClick="setup1(); $(this).hide().next().show();">
                                       <input type=button value="Take Snapshot" onClick="take_snapshot1()">
                                       <input type="hidden" name="image" class="image-tag1">
                                    </div>
                                    <div class="col-md-6">
                              ...
                              <div class="row clearfix">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <div class="form-line">
                                            <button  type="button"  Style="width:123px; float:right;margin-right:5% "  class="btn btn-danger waves-effect "  data-dismiss="modal">Cancel Visit</button>
                                       </div>
                                    </div>
                                 </div>
                              </div>
...
<script type="text/javascript">
   ...
   success:function(data)
   {
    ...
    //alert(obj.visit);
    //$('#appenddata').html(data.visit.visit_no);
    $('#visit_id').val(data.visit[0].id);
    $('#datepicker1').val(data.visit[0].end_date);
    $('#visiting_area1').val(data.visit[0].visiting_area);
     $('#check_in_time1').val(data.visit[0].check_in_time);
     $('#check_out_time1').val(data.visit[0].check_out_time);
      $('#vehicle_no').val(data.visit[0].vehicle_no);
      $('#remarks').val(data.visit[0].remarks);
      var dep='';
      $.each(data.department, function (i, value) {
        if(value.id==data.visit[0].department_id){ var sd="selected='selected'"; }else{ var sd="";}
        dep +='<option value="'+value.id+'" '+sd+'>'+value.name+'</option>';
   
}); $('#dep_id').html(dep);
      var v_ty='';
//console.log(data.visitor_type);
      $.each(data.visitor_type, function (i, visi) {
        if(visi.id==data.visit[0].visitor_type_id){ var vd="selected='selected'"; }else{ var vd="";}
        v_ty +='<option value="'+visi.id+'" '+vd+'>'+visi.name+'</option>';
   
});$('#visitor_t_id').html(v_ty);
      //console.log(data.visit_purpose);
      var v_p='';
        $.each(data.visit_purpose, function (k, visit_p) {
        if(visit_p.id==data.visit[0].visit_purpose_id){ var vp="selected='selected'"; }else{ var vp="";}
        v_p +='<option value="'+visit_p.id+'" '+vp+'>'+visit_p.name+'</option>';
   
});$('#visit_purpose_id').html(v_p);
        //alert(v_p);
        var us='';
        $.each(data.user, function (k, users) {
        if(users.id==data.visit[0].user_id){ var user="selected='selected'"; }else{ var user="";}
        us +='<option value="'+users.id+'" '+user+'>'+users.name+'</option>';
...
<script type="text/javascript">
   ...
   var v_area_error1= $('#v_area_error1').val();
   var check_in_time1= $('#check_in_time1').val();
    //var check_out_time= $('#check_out_time').val();
   // var purpose_id = $('#purpose_id').val();
   //alert(department_id);
   var err=0;
   ...
   if(v_area_error1==""){
     err=1;
     $('#v_area_error1').html('<span style="color:red">Visiting Area is required</span>');
     return false;
   }else{
     $('#v_area_error1').html();
   }
   if(check_in_time1==""){
     err=1;
     $('#c_in_error1').html('<span style="color:red">Check In Time is required</span>');
     return false;
   }else{
     $('#c_in_error1').html();
   }
   ...
   // submit add visit form data
   if(err==0){
    console.log($('#editvisitform').serialize());
     $.ajax({
