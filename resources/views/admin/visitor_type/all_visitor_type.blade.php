            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <strong>All</strong> Visitor Type
                            </h2>
                            ...
                            <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="center">Visitor Type</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">{{$visitor_types->name}}</td>
                                            <td class="center">
                                                <?php
                                                if($visitor_types->status == '1'){
                                                   $status="Active";
                                                }else{
                                                   $status="Inactive";
                                                }
                                                ...
                                                {{$status}}</td>
                                            <td class="center">
                                                <form action="{{route('visitor_type.destroy', [$visitor_types->id])}}" method="POST">
                                             @method('DELETE')
                                             @csrf
                                                <a href="{{route('visitor_type.edit', [$visitor_types->id])}}" class="btn btn-tbl-edit">
