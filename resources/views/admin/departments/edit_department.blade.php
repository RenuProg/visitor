            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h1>
                                <strong style="color: #fff;">Edit Department</strong></h1>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="name" class="form-control" value="{{$department['name'] }}" placeholder="Department Name" />
                                            @error('name')
                                   ...
                                   <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <a href="{{route('department.index')}}" class="btn btn-danger waves-effect">
                                                   Cancel
                                                </a>
